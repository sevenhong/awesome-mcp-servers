...
- [Wanaku MCP Router](https://github.com/wanaku-ai/wanaku) - ☕ ☁️ 🏠 The Wanaku MCP Router is a SSE-based MCP server that provides an extensible routing engine that allows integrating your enterprise systems with AI agents.
