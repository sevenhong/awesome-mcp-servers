...
- [zinja-coder/jadx-ai](https://github.com/zinja-coder/jadx-ai) 🐍 ☕ 🏠 🍎 🪟 🐧 - JADX-AI is a plugin and MCP Server for the JADX decompiler that integrates directly with Model Context Protocol (MCP) to provide live reverse engineering support with LLMs like Claude.
