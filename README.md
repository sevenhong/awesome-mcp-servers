...
- [Prisma MCP Server](https://www.prisma.io/docs/postgres/mcp-server) 🐍 🏠 - Gives LLMs the ability to manage Prisma Postgres databases (e.g. spin up new database instances or run schema migrations).
