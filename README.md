...
- [@benborla29/mcp-server-mysql](https://github.com/benborla/mcp-mysql-server) ☁️🏠 - MySQL database integration in NodeJS with configurable access controls and schema inspection
