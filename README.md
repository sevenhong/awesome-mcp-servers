...
- [GistPad-MCP](https://github.com/lostintangent/gistpad-mcp) 📓 ✏️ - Use GitHub Gists to manage and access your personal knowledge, daily notes, and reusable prompts. This acts as a companion to https://gistpad.dev and the [GistPad VS Code extension](https://aka.ms/gistpad).
